          ...
          properties: {
            ...
            medicine: {
              ...
              properties: {
                ...
                form: { type: Type.STRING, description: "Medicine form: 'tablet', 'capsule', 'syrup', 'ampule', 'powder', or 'other'" },
              },
